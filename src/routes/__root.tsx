...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://my-portfolio-gilt-ten-63.vercel.app/og-image.svg?v=20260922" },
      { property: "og:image:alt", content: "Seth Designs portfolio work" },
      { property: "og:image:type", content: "image/svg+xml" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:secure_url", content: "https://my-portfolio-gilt-ten-63.vercel.app/og-image.svg?v=20260922" },
      ...
      { name: "twitter:image", content: "https://my-portfolio-gilt-ten-63.vercel.app/og-image.svg?v=20260922" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400;12..96,600;12..96,700&family=DM+Sans:wght@400;500&display=swap",
      },
